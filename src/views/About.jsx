      ...
      <div className="max-w-7xl mx-auto x-4 sm:px-6 lg:px-8 px-4 md:mt-0 pt-24 pb-12">
        ...
        <div>
          <motion.div>
            ...
            >
              Web developer experimented. I learned to code in various languages
              computers (Javascript, PHP,Python...) . Versatile, I am familiar with
              the different technical stages of creating a site or a web application
              ...
              efficient code. I passionately combine good design, technology, and innovation in
